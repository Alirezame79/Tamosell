...
export default function ProductCard() {
  ...
  return (
    <div className="bg-orange-300 flex gap-3 p-3 m-3 h-24 md:h-28 lg:h-32 rounded cursor-pointer">
      <Image 
      ...
      <div className="flex flex-col justify-between p-2 bg-orange-100 rounded w-full">
